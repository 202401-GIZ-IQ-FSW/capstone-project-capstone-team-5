...
export default function JobInfoo() {
  return (
        ...
        <div>
          ...
          <div className="lg:flex lg:items-center lg:justify-between">
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
                ...
                <div className=" rounded-md border-black border-[1px] transition-all font-light px-2 py-1 h-8 items-center ">
                  Tech
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 flex gap-8 ">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">
                Bachelor's degree in Computer Science, 3+ years of experience in
          ...
          <div className="mt-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">
                Please send your resume and cover letter to hr@techsolutions.com
              </p>
            </div>
          </div>
