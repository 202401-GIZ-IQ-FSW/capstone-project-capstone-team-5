...
export default function Example() {
  return (
    <div className="bg-[#f5f3f3] py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-2 shadow-xl rounded-lg">
        <div className="mx-auto max-w-2xl">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Contact Us</h2>
          <p className="whitespace-no-wrap mt-4 text-lg leading-8 text-gray-600">
            Get in touch with us. We're here to assist you in finding the perfect job opportunities.
          </p>
        </div>

        <div className="flex flex-col lg:flex-row justify-center items-start gap-6 mt-10">
          <div className="w-full lg:w-1/2">
            <form action="#" method="POST" className="space-y-12 mx-20">
              <div>
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-medium leading-6 text-gray-900 text-left">
                  Subject
                </label>
                <div>
                  <input
    ...
    <div class="mx-auto max-w-6xl px-6 text-center lg:px-2 shadow-xl rounded-lg">
        <div class="p-6 flex justify-between">
            ...
            <div class="text-center">
                ...
                <p><a href="mailto:info@company.com" class="text-gray-900 hover:text-[#f1ff52] ">info@company.com</a></p>
                <p><a href="mailto:hello@company.co" class="text-gray-900 hover:text-[#f1ff52] ">hello@company.co</a></p>
            </div>
            <div class="text-center">
