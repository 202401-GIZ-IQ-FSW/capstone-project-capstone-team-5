...
const stats = [
    { label: 'Advanced, Personlized and seamless application process', value: 'Key Features' },
    { label: 'Increased job visibility, Enhanced candidate and Streamlined recruitment process', value: 'Benefits' },
  ...
  export default function Team() {
    return (
      <div className="bg-white py-32">
        ...
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">About Jobconnect</h2>
          <br />
          <p className="text-xl leading-8 text-gray-600">
          Founded in 20XX, jobconnect has been at the forefront of connecting job seekers with their dream opportunities. Our platform aims to revolutionize the job search
          experience by providing innovative solutions for both job seekers and companies.
                </p>
                <br />
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            ...
            <div className="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
              <div className="lg:w-full lg:max-w-2xl lg:flex-auto">
                <p className="text-xl leading-8 text-gray-600">
                  To empower individuals by connecting them with meaningful employment opportunities.
                </p>
                <br></br>
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Our vision</h2>
                <br></br>
                <p className="text-xl leading-8 text-gray-600">
                  To become the leading platform for job seekers and companies to find the perfect match.
                </p>
                <br></br>
  ...
  <div class="flex space-x-4">
    ...
    <div class="rounded-xl overflow-hidden relative text-center p-4 group items-center flex flex-col max-w-sm hover:shadow-2xl transition-all duration-500 shadow-xl">
      ...
      <div class="group-hover:pb-10 transition-all duration-500 delay-200">
        <h1 class="font-semibold text-gray-700">John Doe</h1>
        <p class="text-gray-500 text-sm">CEO<br></br>Leading the company towards</p>
      </div>
    ...
    <div class="rounded-xl overflow-hidden relative text-center p-4 group items-center flex flex-col max-w-sm hover:shadow-2xl transition-all duration-500 shadow-xl">
      ...
      <div class="group-hover:pb-10 transition-all duration-500 delay-200">
        <h1 class="font-semibold text-gray-700">Jane Smith</h1>
        <p class="text-gray-500 text-sm">CTO<br></br>Innovating for a better user experience</p>
      </div>
      <div class="flex items-center transition-all duration-500 delay-200 group-hover:bottom-3 -bottom-full absolute gap-2 justify-evenly w-full">
        <div class="flex gap-3 text-2xl bg-gray-700 text-white p-1 hover:p-2 transition-all duration-500 delay-200 rounded-full shadow-sm">
          <a class="hover:scale-110 transition-all duration-500 delay-200">
    ...
    <div class="rounded-xl overflow-hidden relative text-center p-4 group items-center flex flex-col max-w-sm hover:shadow-2xl transition-all duration-500 shadow-xl">
      ...
      <div class="group-hover:pb-10 transition-all duration-500 delay-200">
        <h1 class="font-semibold text-gray-700">Alice Johnson</h1>
        <p class="text-gray-500 text-sm">Head of HR<br></br>Building a strong team</p>
      </div>
      <div class="flex items-center transition-all duration-500 delay-200 group-hover:bottom-3 -bottom-full absolute gap-2 justify-evenly w-full">
        <div class="flex gap-3 text-2xl bg-gray-700 text-white p-1 hover:p-2 transition-all duration-500 delay-200 rounded-full shadow-sm">
          <a class="hover:scale-110 transition-all duration-500 delay-200">
