...
function AdvanceYourCareerCard(props) {
  return (
    <div className=" flex flex-col text-black w-[350px] rounded-lg bg-gray-50 hover:bg-white shadow p-6 justify-between border-2 border-black  hover:transform hover:-translate-y-2 transition hover:shadow-xl hover:cursor-pointer group">
